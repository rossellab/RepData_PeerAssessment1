...
options(scipen = 999, digits = 2, echo = TRUE)
```
...
I plot an histogram of total steps per day, and I add a red vertical line at the **mean value (`r mean`)** and a blue vertical line at the **median value (`r median`)**.
...
I plot an histogram of total steps per day including imputed values, and I add a red vertical line at the **mean value (`r meanNew`)** and a blue vertical line at the **median value (`r medianNew`)**.
